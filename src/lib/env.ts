...
const envSchema = z.object({
  ...
  LINE_LOGIN_CLIENT_ID: z.string().optional().default(""),
  LINE_LOGIN_CLIENT_SECRET: z.string().optional().default(""),
  LINE_REDIRECT_URI: z.string().optional().default(""),
  ...
  DEVICE_HMAC_WINDOW_SECONDS: z.coerce.number().int().positive().default(300),
